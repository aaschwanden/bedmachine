...
do
  ...
  do
      ...
      ncatted -a _FillValue,topg,o,f,$fill_value -a _FillValue,divHU,o,f,$fill_value -a _FillValue,divHU_umt,o,f,$fill_value -a _FillValue,divHU_cresis,o,f,$fill_value -a _FillValue,divHU_searise,o,f,$fill_value ${project}/${project}_${GS}m_alpha_${alpha}_gamma_${gamma}_masked.nc
      ...
      basemap-plot.py -p medium --geotiff_file MODIS${project}250m.tif --map_resolution $R --colorbar_label -v divHU --singlerow -o ${project}/${project}_${GS}m_alpha_${alpha}_gamma_${gamma}_divHU.png ${project}/${project}_${GS}m_alpha_${alpha}_gamma_${gamma}_masked.nc
...
do
    ...
    basemap-plot.py -p medium --geotiff_file MODIS${project}250m.tif  --map_resolution $R --colorbar_label --bounds -100 100 -v divHU_searise --singlerow --colormap RdBu_r -o ${project}/${project}_${GS}m_searise_divHU_${GS}m.png ${project}/${project}_${GS}m_alpha_${alpha}_gamma_${gamma}_masked.nc

...
for gamma in 0.0 1.0 2.0 5.0 10.0 20.0 50.0 100.0 200.0 500.0 1000.0 2000.0 5000.0 10000.0 20000.0 50000.0 10000.0
do
    ...
    do
        ...
        do
            ...
            # thk difference
            #basemap-plot.py -p medium --geotiff_file ${project}_gimpdem_90m_hillshade.tif --map_resolution $R --colorbar_label -v thk --singlerow --colormap RdBu_r  --bounds -100 100 --obs_file ${project}_flightlines_thk_${GS}m.nc -o ${project}/${project}_${GS}m_alpha_${alpha}_gamma_${gamma}_${exp}_thkdiff.png ${project}/${project}_${GS}m_alpha_${alpha}_gamma_${gamma}_${exp}.nc
          done
     done
done

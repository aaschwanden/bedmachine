...
for scale in 0.9;
do
    im-plot.py -p twocol --colorbar_position right --inner_titles '$\gamma$=0,$\gamma$=0.1,$\gamma$=0.5,$\gamma$=1,$\gamma$=10,$\gamma$=100' --colorbar_label -v topg --colormap /Users/andy/base/pypismtools/colormaps/wiki-2.0.cpt -o ${project}_${GS}m_alpha_${alpha}_gammas_vscale_${scale}_${exp}_topg.pdf ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.1_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.5_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_1.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_10.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_100.0_vscale_${scale}_${exp}.nc
    im-plot.py -p twocol --colorbar_position right --inner_titles '$\gamma$=0,$\gamma$=0.1,$\gamma$=0.5,$\gamma$=1,$\gamma$=10,$\gamma$=100' --colorbar_label -v divHU --colormap RdBu_r  --bounds -500 500 -o ${project}_${GS}m_alpha_${alpha}_gammas_vscale_${scale}_${exp}_divHU.pdf ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.1_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.5_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_1.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_10.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_100.0_vscale_${scale}_${exp}.nc
    im-plot.py -p twocol --colorbar_position right --inner_titles '$\gamma$=0,$\gamma$=0.1,$\gamma$=0.5,$\gamma$=1,$\gamma$=10,$\gamma$=100' --colorbar_label -v res_flux --colormap RdBu_r  --bounds -500 500 -o ${project}_${GS}m_alpha_${alpha}_gammas_vscale_${scale}_${exp}_res_flux.pdf ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.1_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_0.5_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_1.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_10.0_vscale_${scale}_${exp}.nc ${project}/${project}_${GS}m_alpha_${alpha}_gamma_100.0_vscale_${scale}_${exp}.nc
done
